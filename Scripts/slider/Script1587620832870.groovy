...
WebUI.openBrowser('https://www.informatica.com/lp/data-quality-roi-calculator.html#fbid=LQxojDf4p')
...
WebElement draggablePartOfScrollbar = driver.findElement(By.className('range-slider__range'))
...
int numberOfRangeToDragTheSlider = 130
